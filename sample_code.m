...
c_epitaxy.fluid = 'vacuum';
c_epitaxy.print_performance();
c_epitaxy.print_performance_for_excel();
pause

parameter_constraints = {{'min_t', 'min_w', 'max_v_bridge'}, {1e-6, 1e-6, 5}};
nonlinear_constraints = {{'omega_min_hz', 'max_power', 'min_k', 'max_k'}, {5*freq_max, 2e-3, .1, 10}};
...
nonlinear_constraints = {{'omega_min_hz', 'delta_temp'}, {5*freq_max, 10}};
