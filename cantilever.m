...
classdef cantilever
  properties
    ...
    % Optional parameters for modeling a stiffener/actuator at the
		...
		% Options = 'none', 'step', 'thermal', 'piezoelectric'. Default = 'None'
    cantilever_type; 

		% 'step' stack = silicon/oxide/metal (t/t_oxide/t_a)
    % 'thermal' stack = silicon/oxide/metal (t/t_oxide/t_a)
    % 'piezoelectric' stack = silicon/oxide/seed/metal/piezoelectric/metal
  ...
  properties (Constant)
    ...
    % AlN: "Process-dependent thin-film thermal conductivities
		%       	for thermal CMOS MEMS"
