...
classdef cantileverImplantation < cantilever
  ...
  methods
    ...
    function self = cantileverImplantation(freq_min, freq_max, ...
    ...
    function [x, active_doping, total_doping] = doping_profile(self)
      ...
      n = interpn(x, self.lookupTableData.ImplantDopants, ...
        ...
        x, self.dopantNumber(), self.implantation_dose, ...
				self.implantation_energy, self.annealing_temp-273, ...
    ...
    function Xj = junction_depth(self)
      Xj = interpn(self.lookupTableData.ImplantDopants, ...
				self.lookupTableData.ImplantDoses, ...
        self.lookupTableData.ImplantEnergies, ...
				self.lookupTableData.AnnealTemps, ...
        self.lookupTableData.AnnealTimes, ...
        ...
        self.dopantNumber(), self.implantation_dose, ...
				self.implantation_energy, self.annealing_temp-273, ...
        self.annealing_time/60, self.annealNumber(), 'linear');
    end
    
    function Rs = sheet_resistance(self)
      Rs = interpn(self.lookupTableData.ImplantDopants, ...
				self.lookupTableData.ImplantDoses, ...
        self.lookupTableData.ImplantEnergies, ...
				self.lookupTableData.AnnealTemps, ...
        self.lookupTableData.AnnealTimes, ...
    ...
    function Nz = Nz(self)
      Nz = interpn(self.lookupTableData.ImplantDopants, ...
				self.lookupTableData.ImplantDoses, ...
        self.lookupTableData.ImplantEnergies, ...
				self.lookupTableData.AnnealTemps, ...
        self.lookupTableData.AnnealTimes, ...
    ...
    function beta = beta(self)
      Beta1 = interpn(self.lookupTableData.ImplantDopants, ...
			self.lookupTableData.ImplantDoses, ...
        self.lookupTableData.ImplantEnergies, ...
				self.lookupTableData.AnnealTemps, ...
        self.lookupTableData.AnnealTimes, ...
      ...
      Beta2 = interpn(self.lookupTableData.ImplantDopants, ...
			self.lookupTableData.ImplantDoses, ...
        self.lookupTableData.ImplantEnergies, ...
				self.lookupTableData.AnnealTemps, ...
        self.lookupTableData.AnnealTimes, ...
      ...
      beta = Beta1 - 2/(self.t*1e6)*Beta2; 
    end
    
		% Calculated from the dopant diffusion length, not the Si diffusion length
		% Based upon personal communications with L.K.J. Vandamme (Jan 2012)
    ...
    function [lb ub] = doping_optimization_bounds(self, parameter_constraints)
      ...
      lb = [min_annealing_time, min_annealing_temp ...
				min_implantation_energy min_implantation_dose];
      ub = [max_annealing_time, max_annealing_temp ...
				max_implantation_energy max_implantation_dose];
    end
    ...
    function x0 = doping_initial_conditions_random(self, parameter_constraints)
      ...
      annealing_time_random = annealing_time_min + ...
				rand*(annealing_time_max - annealing_time_min);
      annealing_temp_random = annealing_temp_min + ...
				rand*(annealing_temp_max - annealing_temp_min);
      implantation_energy_random = implantation_energy_min + ...
				rand*(implantation_energy_max - implantation_energy_min);
      implantation_dose_random = implantation_dose_min + ...
				rand*(implantation_dose_max - implantation_dose_min);
      
      x0 = [annealing_time_random, annealing_temp_random, ...
				implantation_energy_random, implantation_dose_random];
    end
  end
end