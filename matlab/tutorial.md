# PiezoD MATLAB Tutorial (legacy)

This is the original MATLAB tutorial, retained for historical reference. The MATLAB implementation is no longer maintained -- new users should follow the [Python tutorial](../docs/tutorial.md).
