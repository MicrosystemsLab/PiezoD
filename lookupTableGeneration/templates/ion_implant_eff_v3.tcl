...
# Effective diffusivity model v3: v1 Table A-3 D + linear IV relaxation.
#
# Boron: FLOOXS_2026 point defects + v5 {311} clustering + v5 surface recomb
#   - Table A-3 effective D with FLOOXS_2026 ScaleI (same D values as v1)
...
#   - alpha_311=0.2 (same as v1, recalibrated for Table A-3 D)
