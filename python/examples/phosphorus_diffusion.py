...
ax1.semilogy(z_diff * 1e9, np.maximum(active_diff, 1.0), "b--", label="Net active")
...
ax2 = axes[1]
ax2.semilogy(z_epi * 1e9, total_epi, "r-", label="Total")
ax2.semilogy(z_epi * 1e9, np.maximum(active_epi, 1.0), "b--", label="Net active")
